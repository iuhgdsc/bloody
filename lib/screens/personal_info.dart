              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Container(
                      width: 230,
                      child: const Text("Nguyễn Việt Hoàng",
                        style: TextStyle(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Container(
                      width: 230,
                      child: const Text("Chưa xác thực",
                        style: TextStyle(
                            color: Color(0xFF717171),
                            fontWeight: FontWeight.w400,
                            fontSize: 16
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Container(
                      width: 230,
                      child: const Text("12 Nguyễn Văn Bảo, phường\n04, quận Gò Vấp, TP. HCM",
                        style: TextStyle(
                            color: Color(0xFF717171),
                            fontWeight: FontWeight.w400,
                            fontSize: 14
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Container(
                      width: 230,
                      child: const Text("Chưa thiết lập",
                        style: TextStyle(
                            color: Color(0xFF717171),
                            fontWeight: FontWeight.w400,
                            fontSize: 14
