...
class _MultipleChoiceQuestionState extends State<MultipleChoiceQuestion> {
  ...
  void initState() {
    super.initState();
    _isCheckedList = List<bool>.filled(widget.question.answers.length, false);
  }
  ...
  void _updateAnswer(String answer) {
    var answerIndex = widget.question.answers
        .indexWhere((element) => element == widget.question.answers[0]);

    // if (answerIndex != -1) {
    //   widget.answers[answerIndex] = Answer(questionId: widget.questionId, answer: answer);
    // } else {
    //   widget.answers.add(Answer(questionId: widget.questionId, answer: answer));
    // }
  }
}
